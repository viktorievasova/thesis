...
\begin{itemize}
\item {3DComputerVisionOnTheAndroidPlatform.pdf (the text of the thesis), }
\item {code\_resources folder containing the implementation of the application,}
\item {user\_manual.pdf,}
\item {developer\_documentation.pdf and}
\item {sample\_data folder (a folder containing smaples of input images).}
\end{itemize}
