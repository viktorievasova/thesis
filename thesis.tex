...
% \centerline{\mbox{\includegraphics[width=60mm]{img/logo.eps}}} % XXX pozor, include graphics je zakomentovane; take zkontrolovat, jestli mame ve vyslednem PDFku to logo
