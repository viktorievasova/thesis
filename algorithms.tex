...
To generate the set of features and their description, four major steps are followed.
...
%It can be illustrated as a 3D parabola interpolating the local sample points.
