...
In Chapter \ref{chap:algorithms}, we rigorously discuss the problem of 3D reconstruction from images. % XXX tenhle text je nutne doplnit 
...
Finally, we evaluate and benchmark the resulting application (Chapter \ref{chap:implementation}).  % XXX je tohle odkaz na spravnou kapitolu?
